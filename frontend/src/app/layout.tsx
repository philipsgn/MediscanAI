...
export const metadata: Metadata = {
  ...
  description:
    "Mediscan AI giúp bạn nhận diện, chuẩn hóa và phân tích tương tác thuốc thông minh bằng công nghệ AI Vision. Hỗ trợ quét toa thuốc và vỏ hộp, cảnh báo nguy cơ trùng lặp hoạt chất và tương tác chéo.",
